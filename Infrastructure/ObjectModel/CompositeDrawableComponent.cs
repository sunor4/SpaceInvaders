        ...
        where ComponentType : IGameComponent
    {
        ...
        public override void Initialize()
        {
            if (!m_IsInitialized)
            {
                ...
                (Game as BaseGame).ResolutionManager.ResolutionChanged += CompositeDrawableComponent_ResolutionChanged;
                base.Initialize();
        ...
        protected virtual void CompositeDrawableComponent_ResolutionChanged()
        {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            m_SpriteBatch.Begin(
                ...
                this.DepthStencilState, this.RasterizerState, this.Shader, Matrix.Identity);
