...
namespace Infrastructure.Managers
{
    ...
    public class InputManager : GameService, IInputManager
    {
        ...
        public Rectangle MouseBounds
        {
            get
            {
                Point mousePoint = new Point((int) (MouseState.Position.X), (int) (MouseState.Position.Y));
                return new Rectangle(mousePoint, MouseSize);
            }
        }

        public bool DidMouseMoveThisFrame
        {
            get { return MouseState.Position != PrevMouseState.Position; }
        }
